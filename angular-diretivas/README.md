...
Cada exercício é um componente independente, em `src/app/exercicios/`, e todos aparecem na mesma página (com índice no topo).
...
- `src/app/models` e `src/app/data` guardam a interface `Produto` e os dados reaproveitados nos exercícios 8 a 11.
...
- Nos exercícios 6, 13, 14 e no desafio foram incluídos botões extras de "Limpar" e "Restaurar" apenas para permitir testar as mensagens de lista vazia.
...
- Preencha Aluno, Turma e Data no arquivo `src/app/app.html`.
